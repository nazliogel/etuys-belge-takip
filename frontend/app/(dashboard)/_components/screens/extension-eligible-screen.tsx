        ...
        <div className="h-[480px] overflow-auto">
          <table className="w-full text-left text-sm">
            <thead className="sticky top-0 z-10 border-b border-slate-200/60 bg-slate-50/95 text-[11px] font-bold uppercase tracking-wider text-slate-500 backdrop-blur-sm">
              <tr>
                <th className="px-3 py-1.5">Belge No</th>
                <th className="px-3 py-1.5">Firma</th>
                <th className="px-3 py-1.5">Belge Başlangıç</th>
                <th className="px-3 py-1.5">Belge Bitiş</th>
                <th className="px-3 py-1.5">Süre Uzatım</th>
                <th className="px-3 py-1.5">Destekleme Sınıfı</th>
                <th className="px-3 py-1.5">Durum</th>
                <th className="px-3 py-1.5 text-right">Detay</th>
              </tr>
            </thead>
